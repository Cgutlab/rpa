...
<main>
	<div class="container">
		...
		<div class="row">
		    <div class="col s12">
			{!!Form::model($galeria, ['route'=>['prcgaleria.update', $galeria->id], 'method'=>'PUT', 'files' => true])!!}
				<div class="row">
					...
					<div class="input-field col s9">
						...
						@foreach($items as $item)						
            				<option value="{{$item->id}}" @if($item->id == $galeria->id_prc_items) selected @endif>{!!$item->titulo!!}</option>
						@endforeach
						</select>
					</div>				
		        </div>

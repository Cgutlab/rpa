...
if(isset($_GET['mensaje'])){
    ...
    <?php }else{ ?>
        ...
        <div class="alert alert-danger text-center" role="alert"  style="background: var(--color2); border-bottom: 1px solid gray;">
        ...
        <div id="estado1" >
            ...
            <div class="col l12">
                ...
                <div class="row">
                    ...
                    <div class="input-field col l3 m6 s12 pull-l1 right">

                        <a type="submit" id="botonSiguienteEstado" class="btn right z-depth-0" style="margin-top: 20px; background-color:var(--color2); color:white; font-weight: bold;">Siguiente</a>
            ...
            <div class="row">
                ...
                <div align="right">
                  ...
                  <div class="file-field col l5 m6 s12 push-l1">
                    ...
                    <div class="btn" style="background: var(--color2);">
                ...
                <div class="input-field col l3 pull-l1 right">
                    ...
                    <button type="submit" id="botonSiguienteAnterior" class="btn right z-depth-0" style="margin-top: 20px; background-color:var(--color2); color:white; font-weight: bold;">Enviar</button>

...
@if($all1_categoria->id_padre != '0' && $all1_categoria->id == $variable)

  @foreach($all2_categorias as $all2_categoria)
  @if($all2_categoria->id == $all1_categoria->id_padre)
...
@foreach($all2_categorias as $all2_categoria)
@if($all2_categoria->id_padre == '0' && $all2_categoria->id == $variable)
<a class="fs18 fc5 fw5 mayus" href="{{route('categoria',$all2_categoria->id)}}">{{$all2_categoria->titulo}}</a>
@endif
@endforeach
</div>
...
@media all and (min-width: 993px) {
  ...
  .card-image{
   ...
   <div class="collapsible-body">
      ...
      <div class="collapsible-body" style="margin-left: 15px;">
...
<div class="col m12 l4">
  ...
  <div class="card z-depth-0">
    ...
    <a href="{{route('categoria', $categoria->id)}}">
        ...
        <img class="imagenMismoTamano" src="{{asset('imagenes/img_cat/'.$categoria->imagen)}}" style="border: 1px solid #DDD; border-top: 5px solid var(--color2); ">
              ...
              {{-- 
               ...
               --}}
                        ...
                        @if($galeria->id_producto == $producto->id)
                                    ...
                                    @endif          
                        <img class="imagenMismoTamano" src="{{asset('imagenes/galerias/'.$galeria->imagen)}}" style="border: 1px solid #DDD; border-top: 5px solid var(--color2); ">

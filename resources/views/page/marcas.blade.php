...
<div class="col m12 l4">
  ...
  <div class="card z-depth-0">
    ...
    <a href="{{route('fmarcas', $marcax->id)}}">
        ...
        <img class="responsive-img" src="{{asset('imagenes/marcas/'.$marcax->imagen)}}" style="border: 1px solid #DDD; border-top: 5px solid var(--color2);">
